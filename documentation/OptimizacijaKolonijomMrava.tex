...
\abstract{
U radu je opisan algoritam zasnovan na ponašanju mrava i mravljih kolonija poznatiji kao $ACO$ (eng.~{\em ant colony optimization}). Primena algoritma je prikazana na rešavanju problema trgovačkog putnika kao jednog od najpoznatihih problema iz grupe $NP$ teških problema diskretne i kombinatorne optimizacije. Prikazana je implementacija algoritma kao i ponašanje algoritma usled promene vrednosti različitih parametara koji su ključni za sam algoritam.
}
